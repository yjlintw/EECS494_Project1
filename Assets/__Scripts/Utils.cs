...
public enum BoundsTest {
	center, // Is center of GameObject on screen
...
public class Utils : MonoBehaviour {
	...
	public static Bounds CombineBoundsOfChildren (GameObject go) {
		...
		foreach (Transform t in go.transform) {
			// Expand b to contain their Bounds
	...
	public static Vector3 BoundsInBoundsCheck (Bounds bigB, Bounds lilB, 
		...
		switch (test) {
		// The center test determines what off would have to be applied
		...
		case BoundsTest.onScreen:
			...
			// The offScreen test determines what off would be need to be applied
			// to move any time part of lilB inside of B
